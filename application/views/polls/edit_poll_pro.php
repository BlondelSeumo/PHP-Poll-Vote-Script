...
<div class="panel panel-default">
  ...
  <div class="panel-body"> 
	...
	<div class="form-group">
	    ...
	    <div class="col-sm-10">
	      <input type="checkbox" class="form-control" name="user_restriction" value="1" <?php if($poll->user_restricted) echo "checked" ?>>
	...
	<div class="form-group">
	    ...
	    <div class="col-sm-10">
	      <input type="checkbox" class="form-control" name="ip_restriction" value="1" <?php if($poll->ip_restricted) echo "checked" ?>>
	...
	<div class="form-group">
	    ...
	    <div class="col-sm-10">
	      <input type="checkbox" class="form-control" name="cookie_restriction" value="1" <?php if($poll->cookie_restricted) echo "checked" ?>>
	...
	<div class="form-group">
	    ...
	    <div class="col-sm-10">
	      <input type="checkbox" class="form-control" name="show_results" value="1" <?php if($poll->show_results) echo "checked" ?>>
	...
	<div class="form-group">
	    ...
	    <div class="col-sm-10">
	      ...
	      <option value="0" <?php if($poll->vote_type ==0) echo "selected" ?>><?php echo lang("ctn_373") ?></option>
	      <option value="1" <?php if($poll->vote_type ==1) echo "selected" ?>><?php echo lang("ctn_374") ?></option>
	      </select>
	...
	<div class="form-group">
	    ...
	    <div class="col-sm-10">
	      ...
	      <?php foreach($themes->result() as $r) : ?>
	      	<option value="<?php echo $r->ID ?>" <?php if($r->ID == $poll->themeid) echo "selected" ?>><?php echo $r->name ?></option>
	      <?php endforeach; ?>
	      </select>
