...
function toggle_realtime() 
{
	if(myTime) {
		...
		myTime = setInterval(function(){ get_poll_results() }, 10000);
	}
}
...
function create_answer_area(answerid) 
{
	...
	var html = '<div class="answer-box group-spacing" id="answer-area-id-'+answerid+'">'
              ...
              +'<p><input type="file" name="userfile" value="Select Image"></p><p><input type="submit" class="btn btn-primary btn-xs" value="Upload"/></p>'
              +'</form>'
              +'<p><button type="button" class="btn btn-danger btn-xs" onclick="delete_image('+answerid+')"><span class="glyphicon glyphicon-remove"></span> Delete Image</button></p>'
              +'</div>'
              +'</div>'
				+'<div class="input-group">'
	  			+'<input type="text" class="form-control answer-field" id="answer-id-'+answerid+'" aria-label="..." placeholder="Enter your answer.">'
  				+'<div class="input-group-btn">'
  				+'<button type="button" class="btn btn-default" title="Add Picture" onclick="add_picture('+answerid+')"><span class="glyphicon glyphicon-picture"></span></button>'
  				+'<button type="button" class="btn btn-default" title="Update Answer" onclick="update_answer('+answerid+')"><span class="glyphicon glyphicon-ok"></span></button>'
  				+'<button type="button" class="btn btn-default" title="Delete Answer" onclick="delete_answer('+answerid+')"><span class="glyphicon glyphicon-remove"></span></button>'
  				+'</div>'
				+'</div>'
				+'</div>';
